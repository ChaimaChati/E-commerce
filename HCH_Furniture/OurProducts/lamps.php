...
<body>
	...
	<div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 100%;">
		<div>
		<?php 
			$sql="SELECT * FROM products WHERE available >='1' AND item ='lamp'  ORDER BY id DESC LIMIT 10";
			$result = $conn->query($sql);
						...
						echo '
							<ul style="float: left;">
								<li style="float: center; padding: 0px 15px 25px 25px;">
                                	...
                                	<img src="../image/product/lamp/'.$picture.'" alt="" style="width: 400px; height: 400px">
                            		</div>
