    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="amado_product_area section-padding-100">
            ...
            <div style="padding: 15px 0px; font-size: 15px; margin: 0 auto; display: table; width: 100%;">
                <div>
                    <?php 
                        $sql="SELECT * FROM products WHERE available >='1' AND item ='bed'  ORDER BY id DESC LIMIT 10" or die(mysql_error());
                        $result = $conn->query($sql);
                        ...
                        echo '
                            <ul style="float: left;">
                                <li style="float: center; padding: 0px 15px 25px 25px;">
                                    ...
                                    <img src="../image/product/bed/'.$picture.'" alt="" style="width: 400px; height: 400px">
                                    </div>
